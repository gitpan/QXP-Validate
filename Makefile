# This Makefile is for the QXP::Validate extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/QXP/Validate.pm]
#     AUTHOR => q[Sriram Rajagopalan <rjsri@cpan.org>]
#     NAME => q[QXP::Validate]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/QXP/Validate.pm]
#     clean => { FILES=>q[QXP-Validate-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/QXP/Validate.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)\QXP
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\QXP
...
TO_INST_PM = lib/QXP/Validate.pm

PM_TO_BLIB = lib/QXP/Validate.pm \
	blib\lib\QXP\Validate.pm
...
DISTNAME = QXP-Validate
DISTVNAME = QXP-Validate-1.00
...
Validate.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"QXP::Validate\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/QXP/Validate.pm $(INST_MAN3DIR)\QXP.Validate.$(MAN3EXT) 
...
clean :: clean_subdirs
	-$(RM_RF) QXP-Validate-* ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all $(INST_ARCHAUTODIR)/extralibs.ld perlmain.c tmon.out mon.out so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe perl perl$(EXE_EXT) $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def lib$(BASEEXT).def $(BASEEXT).exp $(BASEEXT).x core core.*perl.*.? *perl.core core.[0-9] core.[0-9][0-9] core.[0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9] core.[0-9][0-9][0-9][0-9][0-9]
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(MAKEFILE_OLD) $(FIRST_MAKEFILE) blib\lib\QXP\Validate.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) "name:         QXP-Validate" >> META.yml
	$(NOECHO) $(ECHO) "version:      1.00" >> META.yml
	$(NOECHO) $(ECHO) "version_from: lib/QXP/Validate.pm" >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) "    <AUTHOR>Sriram Rajagopalan &lt;rjsri@cpan.org&gt;</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')"\
	  lib/QXP/Validate.pm blib\lib\QXP\Validate.pm 
	$(NOECHO) $(TOUCH) $@
